...
### 1.1 项目目标（当前可识别）
- 主目标已经从“文件上传工具”演进为“文件运维平台 + AIOps 能力”。
- 代码中已存在三条主链路：文件上传链路、告警决策链路、AI 分析链路。
...
- 安全基线：Token 鉴权、CORS 白名单、路径越权防护。

### 1.3 核心与边缘能力划分
- 核心能力
  - 文件采集上传可靠性（监控、入队、上传、恢复、可见性）。
