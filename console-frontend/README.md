...
React + TypeScript + Vite 单页应用，用于展示 Go 后端的仪表盘与操作入口（目录树/文件列表/上传记录/日志 Tail/配置更新）。
...
- 文件 Tail：选中文件后每 2 秒拉取一次（`LOG_POLL_MS=2000`）。
