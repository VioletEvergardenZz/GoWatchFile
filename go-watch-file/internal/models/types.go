...
type Config struct {
	...
	UploadQueueSaturationThreshold   float64       `yaml:"upload_queue_saturation_threshold"`
	UploadQueueCircuitBreakerEnabled *bool         `yaml:"upload_queue_circuit_breaker_enabled"`
...
type HealthSnapshot struct {
	...
	QueueShedTotal     uint64               `json:"queueShedTotal"`
